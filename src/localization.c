...
// Spanish translation https://github.com/beta215
static char* es_localization_array[]={
    ICON_FK_FILE_O " Load Game", ICON_FK_FILE_O "Abrir ROM",
    "Up", "Arriba",
    "Down", "Abajo",
    "Left", "Izquierda",
    "Right", "Derecha",
    "Start", "Start",
    "Select", "Select",
    "Fold Screen (NDS)", "Cerrar bisagra (NDS)",
//    "Tap Screen (NDS)", "Bildschirm berühren (NDS)",
//    "Emulator " ICON_FK_PAUSE "/" ICON_FK_PLAY, "Emulator " ICON_FK_PAUSE "/" ICON_FK_PLAY, 
//    "Emulator " ICON_FK_BACKWARD,        "Emulator " ICON_FK_BACKWARD,
//    "Emulator " ICON_FK_FORWARD,         "Emulator " ICON_FK_FORWARD,
//    "Emulator " ICON_FK_FAST_FORWARD,    "Emulator " ICON_FK_FAST_FORWARD,
    "Capture State 0", "Guardar estado 0",
    "Restore State 0", "Restaurar estado 0",
    "Capture State 1", "Guardar estado 1",
    "Restore State 1", "Restaurar estado 1",
    "Capture State 2", "Guardar estado 2",
    "Restore State 2", "Restaurar estado 2",
    "Capture State 3", "Guardar estado 3",
    "Restore State 3", "Restaurar estado 3",
    "Analog Up/Down", "Analógico arriba/abajo",
    "Analog Left/Right", "Analógico izquierda/derecha",
//    "Analog L", "Analógico L",
//    "Analog R", "Analógico R",
    "Display FPS: %2.1f\n", "FPS de pantalla: %2.1f\n",
    "Emulation FPS: %2.1f\n", "FPS de emulación: %2.1f\n",
    ICON_FK_VOLUME_UP " Audio", ICON_FK_VOLUME_UP " Audio",
    "Left Audio Channel", "Canal de audio izquierdo",
    "Right Audio Channel", "Canal de audio derecho",
    "Channel 0", "Canal 0",
    "Channel 1", "Canal 1",
    "Channel 2", "Canal 2",
    "Channel 3", "Canal 3",
    ...
    "Channel E", "Canal E",
    "Channel F", "Canal F",
//    "Channel 1 (Square)", "Canal 1 (Rechteck)",
//    "Channel 2 (Square)", "Canal 2 (Rechteck)",
//    "Channel 3 (Wave)", "Canal 3 (Welle)",
    "Channel 4 (Noise)", "Canal 4 (Ruido)",
    "Channel A (FIFO)", "Canal A (FIFO)",
    "Channel B (FIFO)", "Canal B (FIFO)",
//    "Audio Ring (Samples Available: %d)", "Audio-Ringpuffer (Muestras disponibles: %d)",
//    "Audio Watchdog Triggered %d Times", "Audio-Watchdog %d-mal ausgelöst",
    ICON_FK_INFO_CIRCLE " Build Info", ICON_FK_INFO_CIRCLE " Build",
    "Commit Hash:", "Commit-Hash:",
    ICON_FK_SERVER " Registers", ICON_FK_SERVER " Registros",
    ICON_FK_LIST_OL " Disassembly", ICON_FK_LIST_OL " Desensamblador",
    ICON_FK_EXCHANGE " Read/Write Memory Address", ICON_FK_EXCHANGE " Dirección de memoria de lectura/escritura",
    "address", "dirección",
    "data (32 bit)", "dato (32-bit)",
    "data (16 bit)", "dato (16-bit)",
    "data (8 bit)", "dato (8-bit)",
    "data (signed 32b)", "dato (32b signed)",
    "data (signed 16b)", "dato (16b signed)",
    "data (signed 8b)", "dato (8b signed)",
    ICON_FK_PENCIL_SQUARE_O " Memory", ICON_FK_PENCIL_SQUARE_O " Memoria",
    ICON_FK_AREA_CHART " Emulator Stats", ICON_FK_AREA_CHART " Estadísticas de emulación",
    "Show/Hide %s Panel\n", "Mostrar/ocultar %s-panel\n",
    "Press new button " ICON_FK_SIGN_IN, "Presione nuevo botón " ICON_FK_SIGN_IN,
//    "Move Axis ", "Mueva axis ",
    "Not bound", "No asignado",
//    "Hat %d %s", "Hat %d %s",
    "Analog %d %s", "Analógico %d %s",
//    "Key %d", "Botón %d",
    "Analog %d (%0.2f)", "Analógico %d (%0.2f)",
    "Load ROM from file (.gb, .gbc, .gba, .zip)", "Abrir ROM desde archivo (.gb, .gbc, .gba, .zip)",
    "You can also drag & drop a ROM to load it", "También podés arrastrar una ROM para cargarla",
    "Load ROM(.gb, .gbc, .gba, .zip), save(.sav), or GBA bios (gba_bios.bin) from file", "Cargar ROM (.gb, .gbc, .gba, .zip), Save (.sav) o BIOS de GBA (gba_bios.bin)",
    "You can also drag & drop a ROM/save file to load it", "También podés arrastrar una ROM/archivo de guardado para cargarla",
    "Open ROM", "Abrir ROM",
    ICON_FK_CLOCK_O " Load Recently Played Game", ICON_FK_CLOCK_O " Cargar juego recientemente ejecutado",
    ICON_FK_DOWNLOAD " Export Save", ICON_FK_DOWNLOAD  " Exportar archivo de guardado",
    "No recently played games", "No hay juegos recientemente ejecutados",
    ICON_FK_GAMEPAD " Controllers", ICON_FK_GAMEPAD " Control",
    "Controller", "Controlador",
//    "No Controller", "No hay controlador",
    "Reset Default Controller Bindings", "Restablecer configuración predeterminada",
    "Rumble Supported", "Soporta vibración",
    "Rumble Not Supported", "No soporta vibración",
    ICON_FK_FLOPPY_O " Save States", ICON_FK_FLOPPY_O " Saves",
    "Save Slot %d", "Archivo de guardado %d",
    "Capture", "Capturar",
    "Restore", "Restaurar",
    "This save state came from an incompatible build. SkyEmu has attempted to recover it, but there may be issues", "Este archivo de guardado proviene de una build incompatible. SkyEmu intentó recuperarla, pero pueden haber problemas",
    ICON_FK_DESKTOP " Display Settings", ICON_FK_DESKTOP " Bildschirmeinstellungen",
    "Screen Shader", "Shader",
    "Pixelate\0Bilinear\0LCD\0LCD & Subpixels\0Smooth Upscale (xBRZ)\0", "Pixelado\0Bilinear\0LCD\0LCD y subpíxeles\0Escalado suave (xBRZ)\0",
    "Screen Rotation", "Rotación",
    "0 degrees\00090 degrees\000180 degrees\000270 degrees\0", "0 grados\00090 grados\000180 grados\000270 grados\0",
    "Color Correction", "Corrección de color",
    "Strength: %.2f", "Intensidad: %.2f",
    "Screen Ghosting", "Ghosting",
    "Force Integer Scaling", "Forzar escalado en enteros",
    "Stretch Screen to Fit", "Estirar pantalla entera",
    "Game Boy Color Palette", "Paleta de Game Boy Color",
    "GB Palette %d", "Paleta de GB %d",
//    "Reset Palette to Defaults", "Reiniciar paleta a predeterminado",
    ICON_FK_KEYBOARD_O " Keybinds", ICON_FK_KEYBOARD_O " Tastenbelegung",
    "Reset Default Keybinds", "Reiniciar combinaciones de teclas",
    ICON_FK_WRENCH " Advanced",ICON_FK_WRENCH " Avanzado",
    "Light Mode", "Modo claro",
    "Show Debug Tools", "Mostrar herramientas de depuración",
    "Adjust volume", "Ajustar volumen",
    "Show/Hide Menu Panel", "Mostrar/ocultar panel de menú",
    "Rewind at 8x speed", "Retroceder a velocidad 8x",
    "Rewind at 4x speed", "Retroceder a velocidad 4x",
    "Toggle pause/play.\n When paused, the rom selection screen will be shown.", "Pausar/reproducir. Mientras esté pausado, se mostrará la pantalla de selección de ROM",
    "Run at 2x Speed", "Correr a velocidad 2x",
    "Run at the fastest speed possible", "Correr a la velocidad más alta posible",
    "Screen", "Pantalla",
//    "LCD Shader Init", "LCD-Shaderinitialisierung",
    "Menu", "Menú",
    "Copy as..", "Copiar como...",
    ...
    "Opacity", "Opacidad",
    ICON_FK_HAND_O_RIGHT " Touch Control Settings", ICON_FK_HAND_O_RIGHT " Berührungseinstellungen",
    "Hide when inactive", "Ocultar cuando inactivo",
    ICON_FK_FILE_O " Dump Memory to File", ICON_FK_FILE_O " Schreibe Speicherauszug in Datei",
    "Start Address", "Dirección inicial",
    "Size", "Tamaño",
//    "Save Memory Dump", "Guardar copia de la memoria de guardado",
    ICON_FK_RANDOM " Last Branch Locations", ICON_FK_RANDOM " Letzte Sprungziele",
    "Opacity: %.2f", "Opacidad: %.2f",
//    "Step Instruction", "Nächster Befehl",
//    "Step Frame", "Nächstes Frame",
    "Disconnect Log", "Regitro de desconexión",
    ICON_FK_FOLDER_OPEN " Open File From Disk", ICON_FK_FOLDER_OPEN " Öffne Datei von Festplatte",
    "Exit File Browser", "Salir del administrador de archivos",
    "Go back to recently loaded games", "Volver a juegos recientemente ejecutados",
//    "Go to parent directory", "Volver al directorio superior/principal",
    "UP", "ARRIBA",
    "DOWN", "ABAJO",
    "LEFT", "IZQUIERDA",
    "RIGHT", "DERECHA",
    ...
    "Theme", "Tema",
    "Solar Sensor", "Sensor solar",
    "Brightness: %.2f", "Brillo: %.2f",
    "Dark\0Light\0Black\0", "Oscuro\0Claro\0Negro\0",
    "Always Show Menu/Nav Bar", "Siempre mostrar menú/barra de navegación",
    "Language", "Idioma",
    "SPACE", "ESPACIO",
    "ESCAPE", "ESCAPE",
    "ENTER", "ENTER",
    ...
    "DOWN", "ABAJO",
    "UP", "ARRIBA",
    "LEFT_SHIFT", "SHIFT_IZQUIERDO",
    "LEFT_CONTROL", "CONTROL_IZQUIERDO",
    "LEFT_ALT", "ALT_IZQUIERDO",
    "LEFT_SUPER", "SUPER_IZQUIERDO",
    "RIGHT_SHIFT", "SHIFT_DERECHO",
    "RIGHT_CONTROL", "CONTROL_DERECHO",
    "RIGHT_ALT", "ALT_DERECHO",
    "RIGHT_SUPER", "SUPER_DERECHO",
//    "Enable Turbo and Hold Button Modifiers", "Habilitar turbo y mantener modificadores de botones",
    "Scale", "Escala",
    "Scale: %.2f","Escala: %.2f",
    "GBA Color Correction Type","Tipo de corrección de color de GBA",
    ICON_FK_TEXT_HEIGHT " GUI",ICON_FK_TEXT_HEIGHT " Benutzeroberfläche",
    "Full Screen","Pantalla completa",
    ICON_FK_CODE_FORK " Additional Search Paths",ICON_FK_CODE_FORK " Directorios de búsqueda adicionales",
    "Save File/State Path","Archivo de guardado/directorio de guardado",
    "BIOS/Firmware Path","Directorio de BIOS/firmware",
    "Create new save files in Save Path","Crear nuevos archivos de guardado en el directorio de guardado",
    ICON_FK_CROSSHAIRS " Located BIOS/Firmware Files",ICON_FK_CROSSHAIRS " BIOS/firmware encontrados",
    "Force GB games to run in DMG mode","Forzar juegos de GB a correr en modo DMG",
    "Enable HTTP Control Server","Habilitar servidor de control HTTP",
    "Server Port","Puerto de servidor",
    "Toggle Full Screen","Habilitar pantalla completa",
    "Can't find all needed BIOS/Boot ROM/Firmware Files.","No se encontraron todas las BIOS/boot ROMs/firmwares necesarias.",
    "Accuracy will suffer and some features won't work.","La fidelidad será menor y algunas características no funcionarán.",
    // New in v3
    "Avoid NDS Touchscreen", "Evitar pantalla táctil de NDS",
    ICON_FK_PLUS " New", ICON_FK_PLUS " Nuevo"
    ICON_FK_KEY " Action Replay Codes", ICON_FK_KEY " Códigos Action Replay",
    "Create new files in paths", "Crear nuevos archivos en directorio",
    "Cheat Code Path", "Directorio de trucos",
    NULL,NULL
};
...
void se_set_language(int language_enum){
    ...
    if(language_enum==SE_LANG_SPANISH)language_enum = es_localization_array(); 
